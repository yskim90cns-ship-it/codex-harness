...
if (-not (Test-Path $nextCommand)) {
  throw "Next.js was not installed correctly. Delete node_modules and run dev-windows.bat again."
}

Write-Host "Starting dev server. Keep this window open while using the app." -ForegroundColor Green
